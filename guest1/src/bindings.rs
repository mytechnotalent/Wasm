...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:component:guest1:example:encoded world"
)]
#[doc(hidden)]
#[allow(clippy::octal_escapes)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 173] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x070\x01A\x02\x01A\x02\x01\
@\0\x01\0\x04\0\x03run\x01\0\x04\0\x18component:guest1/example\x04\0\x0b\x0d\x01\
